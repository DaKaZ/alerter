# require 'spec_helper'
#
# describe Alerter::Notification do
#
#   before do
...
#
#   it { should ensure_length_of(:subject).is_at_most(Alerter.subject_max_length) }
#   it { should ensure_length_of(:body).is_at_most(Alerter.body_max_length) }
#
...
#     Alerter::Notification.notify_all(recipients,"Subject","Body")
#     #Check getting ALL receipts
#     expect(@entity1.mailbox.receipts.size).to eq 1
#     receipt      = @entity1.mailbox.receipts.first
#     notification = receipt.notification
...
#     Alerter::Notification.notify_all(@entity1,"Subject","Body")
#
#     #Check getting ALL receipts
#     expect(@entity1.mailbox.receipts.size).to eq 1
#     receipt      = @entity1.mailbox.receipts.first
...
#
#   it "should be able to specify a sender for a notification" do
#     Alerter::Notification.notify_all(@entity1,"Subject","Body", nil, true, nil, false, @entity3)
#
#     #Check getting ALL receipts
#     expect(@entity1.mailbox.receipts.size).to eq 1
#     receipt      = @entity1.mailbox.receipts.first
...
#         expect(Alerter::Notification.unread.last).to eq unread_notification
#       end
#     end
#
#     describe ".expired" do
