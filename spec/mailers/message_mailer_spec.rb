...
#TODO : refactor this entire spec
...
describe Alerter::MessageMailer do
  before do
    ...
    @receipt1 = Alerter::Notification.notify_all([@entity1,@entity2,@entity3],"Subject", "Body Body Body Body Body Body Body Body Body Body Body Body")
  end
